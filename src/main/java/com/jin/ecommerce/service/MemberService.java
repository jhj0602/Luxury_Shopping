...
import com.jin.ecommerce.domain.Role;
import com.jin.ecommerce.domain.entity.MemberEntity;
import com.jin.ecommerce.domain.repository.MemberRepository;
...
public class MemberService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userUsername) throws UsernameNotFoundException {
        Optional<MemberEntity> userEntityWrapper = memberRepository.findByUsername(userUsername);
